...
<body>
    <div class="container-fluid" id="cont-3">
        <header id="nav-bar">
          ...
          <a class="nav-link dropdown-toggle" href="admin_dashboard.php" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: white; font-weight: 600; text-align: center; font-size: 18px; margin-top: 20px;  text-transform: capitalize; padding: 20px;">
            Registration
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="insert-candidate.php">Candidate Registration</a></li>
            <li><a class="dropdown-item" href="insert_cand_year.php">Student Registration</a></li>
          </ul>
        </li>
                <li class="nav-item" >
                  <a class="nav-link" href="result.php" style="color:white; font-weight: 600; text-align: center; font-size: 18px; margin-top: 20px;  text-transform: capitalize; padding: 20px;">Results</a>
                </li>
                <li class="nav-item" >
